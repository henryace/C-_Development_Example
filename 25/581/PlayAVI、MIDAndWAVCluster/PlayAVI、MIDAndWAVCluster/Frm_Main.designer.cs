namespace PlayAVIMIDAndWAVCluster
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.選取文件 = new System.Windows.Forms.ToolStripMenuItem();
            ...
            // 
            this.選取文件.Name = "選取文件";
            this.選取文件.Size = new System.Drawing.Size(140, 22);
            this.選取文件.Text = "選取文件(&C)";
            this.選取文件.Click += new System.EventHandler(this.選取文件_Click);
            // 
            // 播放文件
            // 
            this.播放文件.Name = "播放文件";
            ...
            this.optFile.Filter = "視頻文件(*.avi)|*.avi|音頻文件 (*.mid)|*.mid|音頻文件 (*.wav)|*.wav";
            // 
        ...
        private System.Windows.Forms.ToolStripMenuItem 選取文件;
