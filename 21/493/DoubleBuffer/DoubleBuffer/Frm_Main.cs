...
namespace DoubleBuffer
{
    public partial class Frm_Main : Form
    {
        ...
        private void PaintImage(Graphics g)
        {
            ...
            g.FillPath(pgb, path);
            g.DrawString("明日科技歡迎您", new Font("細明體", 18, FontStyle.Bold), new SolidBrush(Color.Red), new PointF(110, 20));
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            Graphics g = e.Graphics;//取得視窗畫布
            g.DrawImage(localBitmap, 0, 0); //在視窗的畫布中繪畫出記憶體中的圖像
