...
namespace QuartzClock
{
    public partial class Frm_Main : Form
    {
        ...
        private void 前端顯示ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (前端顯示ToolStripMenuItem.Checked == true)
            {
                前端顯示ToolStripMenuItem.Checked = false;
                this.TopMost = false;
            }
            else
            {
                前端顯示ToolStripMenuItem.Checked = true;
                this.TopMost = true;
            }
        }

        private void 隱藏時鐘ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Hide();
        }
        ...
        private void 顯示時鐘ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Show();
        }
