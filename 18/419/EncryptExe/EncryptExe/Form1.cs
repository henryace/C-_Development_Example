...
namespace EncryptExe
{
    public partial class Form1 : Form
    {
        ...
        {
            openFileDialog1.Filter = "*.exe(exe可執行檔案)|*.exe|*.mrexe(mrexe加密檔案)|*.mrexe|*.*(所有檔案)|*.*";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("使用密碼加密可執行檔案成功！", "訊息提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("密碼錯誤！", "訊息提示", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    textBox2.Focus();
                }
            }
            finally
        ...
        public static void FileMenu(string strPath, string strName)
        {
            try
            {
                ...
                RKey4.CreateSubKey("使用密碼開啟");
                RKey4.Close();
                RegistryKey RKey5 = Registry.ClassesRoot.OpenSubKey("mrexefile\\shell\\使用密碼開啟", true);
                RKey5.CreateSubKey("command");
                RKey5.Close();
                RegistryKey RKey6 = Registry.ClassesRoot.OpenSubKey("mrexefile\\shell\\使用密碼開啟\\command", true);
